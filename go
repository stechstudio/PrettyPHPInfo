                                                ...
                                                <template x-for="config in group.configs" :key="config.key">
                                                    <tr class="flex flex-col py-1.5 lg:py-0 lg:table-row border-b border-slate-100 dark:border-slate-800/75 last:border-0 lg:hover:bg-slate-50/75 lg:dark:hover:bg-slate-800/40 transition-colors"
                                                        ...
                                                        <td class="py-1 lg:py-2.5 px-6 lg:px-4 group/cell relative" style="overflow-wrap: anywhere"
                                                            :class="isNoValue(config.localValue) ? 'text-slate-300/80 dark:text-slate-600/80 italic' : 'text-slate-600 dark:text-slate-300'">
                                                        ...
                                                        <td x-show="config.hasMasterValue" class="py-1 lg:py-2.5 px-6 lg:px-4 group/cell relative" style="overflow-wrap: anywhere"
                                                            :class="isNoValue(config.masterValue) ? 'text-slate-300/80 dark:text-slate-600/80 italic' : 'text-slate-600 dark:text-slate-300'">
